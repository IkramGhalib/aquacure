                          ...
                          <div class="box box-widget widget-user-2" style="text-align: center;">
                            ...
                            <div class="box-footer no-padding" >
                              <ul class="users-list clearfix">
                                <li id="noLimit">
                                  <b style="font-size: 20px;">  <?php echo $values[$i][3]; ?> </b><br>
                                  <span id="noLimitText" class=""> Temperature<br>(<sup>o</sup>C)</span>
                                </li>
                                
                                <li id="noLimit" >
                                  <b style="font-size: 20px;"><?php echo $values[$i][8]; ?></b><br>
                                  <span id="noLimitText" class=""> Turbidity<br>(NTU)</span>
                                </li>
                                <li id="noLimit" >
                                  <b style="font-size: 20px;"> <?php echo $values[$i][7]; ?> </b><br>
                                  <span id="noLimitText" class=""> TSS<br>(mg/L)</span>
                                </li>
                                <li id="noLimit" >
                                  <b style="font-size: 20px;"><?php echo $values[$i][9]; ?></b><br>
                                  <span id="noLimitText" class=""> TDS<br>(mg/L)</span>
                                </li>
                                
                                <li id="noLimit" >
                                  <b style="font-size: 20px;"><?php echo $values[$i][4]; ?></b><br>
                                  <span id="noLimitText" class=""> pH<br>(NA)</span>
                                </li>
                                <li id="noLimit" >
                                  <b style="font-size: 20px;"><?php echo $values[$i][11]; ?></b><br>
                                  <span id="noLimitText" class=""> Salinity<br>(mg/L)</span>
                                </li>
                                <li id="noLimit" >
                                  <b style="font-size: 20px;"><?php echo $values[$i][10]; ?></b><br>
                                  <span id="noLimitText" class=""> Resistivity<br>( omh.cm)</span>
                                </li>
                                <li id="noLimit" >
                                  <b style="font-size: 20px;"> <?php echo $values[$i][6]; ?></b><br>
                                  <span id="noLimitText" class=""> DO<br>(mg/L)</span>
                                </li>
                                <li id="noLimit" >
                                  <b style="font-size: 20px;"> <?php echo $values[$i][5]; ?></b><br>
                                  <span id="noLimitText" class=""> EC<br>(us/cm)</span>
                                </li>
                              </ul>
