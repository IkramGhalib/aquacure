  ...
  <div class="content-wrapper" style="margin-top: <?php echo $contentmargin?>px">
       ...
       <?php
          ...
          if(isset($_POST['transformer'])){
            ...
            if(empty($_POST['todate']) or empty($_POST['fromdate'])){
              $query = "SELECT transformer.trid, transformer.name , transformer.kva_capacity , tr_kwh_logs.peak , tr_kwh_logs.offpeak  , tr_kwh_logs.Datetime  from transformer , tr_kwh_logs where transformer.trid = tr_kwh_logs.trid and tr_kwh_logs.trid = '".$id."' order by tr_kwh_logs.datetime desc limit 1000";
              ?>
            ...
            else
            {
              ...
              $query = "SELECT transformer.trid, transformer.name , transformer.kva_capacity , tr_kwh_logs.peak , tr_kwh_logs.offpeak  , tr_kwh_logs.Datetime  from transformer , tr_kwh_logs where transformer.trid = tr_kwh_logs.trid  and tr_kwh_logs.trid = '".$id."' AND tr_kwh_logs.datetime BETWEEN '".$fromdate."' AND '".$todate."' order by datetime desc limit 100";
              ?>
           ...
           $query = "SELECT transformer.trid, transformer.name , transformer.kva_capacity , tr_kwh_logs.peak , tr_kwh_logs.offpeak  , tr_kwh_logs.Datetime  from transformer , tr_kwh_logs where transformer.trid = tr_kwh_logs.trid ORDER BY datetime DESC LIMIT  2000";
          }
    ...
    <div  id="overflow" style="overflow-x:auto;">
        ...
        <tr>
          ...
          <th scope="col">Unit (Peak Time)</th>
          <th scope="col">Unit (Off Peak Time)</th>
        ...
        <tr>
          ...
          <td><?php echo round($row['peak']+$row['offpeak'],2);?></td>
