...
<div class="wrapper" style="overflow: hidden;">
  ...
  <div class="content-wrapper" style="margin-top: <?php echo $contentmargin?>px">
    ...
    <section class="content">
      ...
      <?php 
              if ($_SESSION['role'] == "Admin") {
                ?>
                  <button id="add-new-button" class="btn btn-primary" onClick="window.location.href='add_tank.php'"><b>+ Add New Tank</b></button>
                  <br>
                  <br>
                <?php 
              }
    ...
    <th scope="col">Water Capacity (Gal.)</th>
