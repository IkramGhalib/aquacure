...
<html>
<head>
  <?php $pageName = "Transformer eBill"?>
    ...
    <section class="content">
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
            ...
            $query = "select * from tr_billing_postpaid, transformer where tr_billing_postpaid.trid = transformer.trid and bill_id = (select max(bill_id) from tr_billing_postpaid where trid ='".$trid."')";
            //echo $query;
            ...
            <b>Reference No:</b> <?php echo $row['trid']; ?><br>
...
<br>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <button class="btn btn-primary pull-right" onclick="window.location.href = 'bill_pay_tr.php?id=<?php echo $bill_id;  ?>'">Pay Bill</button>
