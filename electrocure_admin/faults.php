...
<div class="wrapper" style="overflow: hidden;">
  ...
  <div class="content-wrapper" style="margin-top: <?php echo $contentmargin?>px">
    ...
    $query= "SELECT faults.*, transformer.name from faults, transformer where transformer.trid = faults.trid limit 1000";
    ...
    <td><?php echo ($row['status'] == "Pending") ? "---" : $row ['resolvedatetime'];  ?></td>
