...
<html>
<head>
  <?php $pageName = "Transformer Collective eBill"?>
    ...
    <section class="content">
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
            ...
            <b style="font-size: 20px">TRANSFORMER COLLECTIVE BILL RECEIPT</b><br>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo round($row['current_reading']-$row['units_consumed'],2); ?></td>
                <td><?php echo round($row['current_reading'],2); ?></td>
                <td><?php echo round($row['units_consumed'],2); ?></td>
                <td><?php echo round($row['total_bill']-$row['last_arrears'],2); ?></td>
                <td><?php echo round($row['last_arrears'],2); ?></td>
     ...
     <br>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <button class="btn btn-danger pull-right" style="margin-right: 5px;" onclick="window.location.href = 'bill_pay_collective_tr.php?id=<?php echo $id; ?>'">Pay Bill</button>
