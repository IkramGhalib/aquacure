...
<head>
  ...
  <?php $pageName = "Connections Dashboard";?>
...
<div class="wrapper" style="overflow: hidden;">
 ...
 //     $con = new DBCon();
      ...
      $q = "SELECT * from connections where cnic ='".$cid."'";
      //echo $q;
                          ...
                          <div class="box box-widget widget-user-2" style="text-align: center;">
                            ...
                            <div class="box-footer no-padding" >
                              ...
                              if($state == "Offline"){
                                ...
                                ?>
                            <button class='btn btn-primary' disabled onclick='window.location.href="connection_device_dashboard.php?id=<?php echo $values[$i][0]; ?>&type=<?php echo ($splitval[$i][2] > 0 ? 3 : 1); ?>"'>Details</button>
