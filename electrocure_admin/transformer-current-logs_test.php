        ...
        <tbody bgcolor="#FFFFFF">
          ...
          if(isset($_POST['transformer'])){
            ...
            if(empty($_POST['todate']) or empty($_POST['fromdate'])){
              ...
              $query = "SELECT FROM_UNIXTIME(FLOOR(UNIX_TIMESTAMP(tr_current_logs.datetime) / (15*60)) * (15*60)) AS chunk_start, tr_current_logs.trid, transformer.name, max(tr_current_logs.B1U) as B1U,max(tr_current_logs.B1M) B1M,max(tr_current_logs.B1L) AS B1L, avg(tr_current_logs.v1) AS v1,avg(tr_current_logs.v2) as v2,avg(tr_current_logs.v3) as v3, max(tr_current_logs.pf1) as pf1, max(tr_current_logs.pf1) as pf2, max(tr_current_logs.pf3) as pf3 from tr_current_logs, transformer where transformer.trid = tr_current_logs.trid and tr_current_logs.trid = '".$id."' GROUP BY trid, chunk_start ORDER BY chunk_start desc limit 500";
            ...
            else
            {
              ...
              $query = "SELECT FROM_UNIXTIME(FLOOR(UNIX_TIMESTAMP(tr_current_logs.datetime) / (15*60)) * (15*60)) AS chunk_start, tr_current_logs.trid, transformer.name, max(tr_current_logs.B1U) as B1U,max(tr_current_logs.B1M) B1M,max(tr_current_logs.B1L) AS B1L, avg(tr_current_logs.v1) AS v1,avg(tr_current_logs.v2) as v2,avg(tr_current_logs.v3) as v3, max(tr_current_logs.pf1) as pf1, max(tr_current_logs.pf1) as pf2, max(tr_current_logs.pf3) as pf3 from tr_current_logs, transformer where transformer.trid = tr_current_logs.trid and tr_current_logs.trid = '".$id."' AND tr_current_logs.datetime BETWEEN '".$fromdate."' AND '".$todate."' GROUP BY trid, chunk_start ORDER BY chunk_start desc";
              ?>
          ...
          $query= "SELECT FROM_UNIXTIME(FLOOR(UNIX_TIMESTAMP(tr_current_logs.datetime) / (15*60)) * (15*60)) AS chunk_start, tr_current_logs.trid, transformer.name, max(tr_current_logs.B1U) as B1U,max(tr_current_logs.B1M) B1M,max(tr_current_logs.B1L) AS B1L, avg(tr_current_logs.v1) AS v1,avg(tr_current_logs.v2) as v2,avg(tr_current_logs.v3) as v3, max(tr_current_logs.pf1) as pf1, max(tr_current_logs.pf1) as pf2, max(tr_current_logs.pf3) as pf3 from tr_current_logs, transformer where transformer.trid = tr_current_logs.trid GROUP BY trid, chunk_start ORDER BY chunk_start desc limit 500";
        }
