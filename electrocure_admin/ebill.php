...
<body>
            ...
            <div class="header">
                ...
                <div class="heading">
                    <h1 style="margin: 10px 10px 10px 35px">
                     ...
                     <div> 
                        <h3 align="center" style="margin-left: -10%;"> ELECTROCURE E-BILL </h3>                                            </div>
                    <div>
                                           </div>
                </div>
            </div>
            <table class="maintable" cellpadding="0" cellspacing="0">
                ...
                <tr style="height: 26px; width: 100%; font-size: .8em;" class="content">
                    <td class="border-rb" style="text-align: center;">
                        <?php echo $connectionNo; ?>
                    </td>
                    <td class="border-rb" style="text-align: center;">
                        <?php echo $referenceNo ?>                    </td>
            ...
            <div style="height: auto; width: 400px; float: right;">
                <table style="width: 100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr style="height: 27px; width: 100%;" class="fontsize">
                        <td colspan="2"> <br><br>
                            <h1><?php echo ($row[3] == 0) ? "UNPAID" : "PAID"; ?></h1>
                        </td>
                    </tr>
                </table>
            </div>
 ...
 -->                                 
                            ...
                            <tr style="height: 30px" class="content">
                                ...
                                <td class="border-r">
                                      <?php echo $currentReading - $UnitConsumed; ?>
                                </td>
                                <td class="border-r">
                                      <?php echo $currentReading ?> 
                                </td>
                                <td class="border-r">
                ...
                <div style="width: 98%; margin: 0 auto 10px;">
                    ...
                    <table style="text-align: center; width: 100%; border-collapse: collapse;">
                        <tr style="height: 30px;">
                            ...
                            <td class="border-rb border-t" style="width: 35%; color: red">
                                <h4>TOTAL BILL</h4>
                            </td>
                        ...
                        <tr style="height: 40px;">
                            ...
                            <td class="border-rb border-r content" style="width: 15%;">
                                <h4><?php echo round($Tarrif * $UnitConsumed); ?></h4>
                            </td>
                            <td class="border-rb border-r content" style="width: 15%;">
                                <?php  echo round($arrears) ?>
                                <br/> 
                                <span> </span>
                            </td>
