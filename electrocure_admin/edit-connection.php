   ...
   // $con = new DBCon();
    ...
    {      
      print_r($_POST);
        ...
        $peak = $_POST['pk1'] + $_POST['pk2'] + $_POST['pk3'];       	
        $offpeak                = $_POST['offpk1'] + $_POST['offpk2'] + $_POST['offpk3'];
		...
		$q1 = "UPDATE connections SET name = '$name', longitude = '$longitude', latitude = '$latitude', tariff = '$tariff', mfactor = '$mfactor', kwhpeak1 = '$pk1',kwhpeak2 = '$pk2',kwhpeak3 = '$pk3', kwhoffpeak1 = '$offpk1', kwhoffpeak2 = '$offpk2', kwhoffpeak3 = '$offpk3', description = '$description', slot1 = '$slot1', slot2 = '$slot2', slot3='$slot3', offpeak = '$offpeak', peak = '$peak', serialNo='$sn', edit_by = '$user', edit_time = CURTIME()  where cid = '".$id."'";
