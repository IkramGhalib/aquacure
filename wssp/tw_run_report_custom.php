...
<head>
    ...
    <?php $pageName = "Tube Well Running Report (Custom)"; ?>
    ...
    <div class="wrapper" style="overflow: hidden;">
        ...
        <div class="content-wrapper" style="margin-top: <?php echo $contentmargin ?>px">
            ...
            <section class="content-header">
                ...
                <br>
                <div class="row">
                     <div class="col col-md-1 pull-right" for>
          ...
          if(isset($_POST['transformer'])){
            $id = $_POST['transformer'];
              ...
              if ($id == 'All') {
                    $query = "SELECT event_logs.pump_id, transformer.name, normal_run, sum(TIMESTAMPDIFF(minute, prev_datetime, event_logs.`datetime`))/60 as run FROM transformer, `event_logs` WHERE event_logs.pump_id = transformer.trid and event = 'Off' and event_logs.datetime between '".$fromdate."' and '".$todate."' and TIMESTAMPDIFF(hour, prev_datetime, event_logs.`datetime`) <= 500 GROUP by pump_id";
                }else{
                    $query = "SELECT event_logs.pump_id, transformer.name, normal_run, sum(TIMESTAMPDIFF(minute, prev_datetime, event_logs.`datetime`))/60 as run FROM transformer, `event_logs` WHERE pump_id = '".$id."' and event_logs.pump_id = transformer.trid and event = 'Off' and event_logs.datetime > now() - INTERVAL 24 hour and TIMESTAMPDIFF(hour, prev_datetime, event_logs.`datetime`) <= 500 GROUP by pump_id";
                }
