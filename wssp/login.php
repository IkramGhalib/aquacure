...
<div class="login-box" >
  <div class="login-logo">
    <img src="images/wssp-logo.png" height="" width="200">
    <br>
	  <a href=""><b>Aqua</b>Cure</a><br>
    <a href="" style="font-size: 30px;">Water Management System</a>
 ...
 <?php
  ...
  require_once("opendb.php");
    ...
    $result = NULL;
        ...
        $query = "select name, email, role from login_info where user_name = :userid and user_password = :pass";
...
?>
  ...
  <br>
  Powered by: <a href="http://www.cispvt.com"><b>CIS pvt. Limited</b></a>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
