     ...
     <div class="user-panel">
      ...
      <ul class="sidebar-menu tree" data-widget="tree">
        ...
        <li><a href="list.php"><i class="fa fa-list"></i><span>Tube Well List</span></a></li>
         <li><a href="wq_list.php"><i class="fa fa-list"></i><span>Water Quality List</span></a></li>
        ...
        <li class="treeview" style="height: auto;">
          ...
          <ul class="treeview-menu" style="display: none;">
            ...
            <!-- <li><a href="event_report.php"><i class="fa fa-circle-o"></i>Event Report</a></li> -->
            <!-- <li><a href="tw_run_fault.php"><i class="fa fa-circle-o"></i>Excessive TW Running Report</a></li> -->
            ...
            <li><a href="signal.php"><i class="fa fa-circle-o"></i>Signal Strength Report</a></li>
