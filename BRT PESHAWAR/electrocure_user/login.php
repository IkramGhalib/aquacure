...
<head>
  ...
  <title>BRT Peshawar Customer Portal | Log in</title>
...
<div class="login-box" >
  <div class="login-logo">
    ...
    <br>
	  <a href=""><b>BRT </b>Peshawar</a>
    <a href=""><h3><b>Customer Portal</b></h3></a>
  </div>
  <!-- /.login-logo -->
    ...
    try
      {
         ...
         if($count > 0){
            while($row = $stmt->fetch())
            {
              ...
              $_SESSION['cid'] = $row[0];
              $_SESSION['name'] = $row[1];
              $_SESSION['billing_method'] = $row[2];
              if ($row['billing_method'] == 'prepaid') {
                $_SESSION['pay'] = 1;
              }else{
                $_SESSION['pay'] = 2;
              }
