...
//echo $arrayData[$db_index][0];
		...
		while($rowdata['moduleid']==$arrayData[$db_index][22])
		{
            ...
            else
            {
                ...
                $insert = $insert . "('".$arrayData[$db_index][0]."','".($rowdata['kwh'.$arrayData[$db_index][19]]/100)."','".($rowdata['kwh'.$arrayData[$db_index][20]]/100)."','".($rowdata['kwh'.$arrayData[$db_index][21]]/100)."','".$offpeak."','".$peak."','".$pkunits."','".$offpkunits."','".$ispeak."','".$rowdata['server_date_time']."')";
