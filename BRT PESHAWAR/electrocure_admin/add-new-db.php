...
<?php
      ...
      try
      {
         ...
         if($count > 0){
            ...
            $q = "INSERT INTO `db_status`(`dbid`) values('$dbid')";
             $result = $conn->query($q) or die(error);


            if ($threephase != 0 or $singlephase != 0) {

            	$q1 = "INSERT INTO `electrocure_brtpswr`.`connections` (`cid`, `name`, `longitude`, `latitude`, `slot1`, `slot2`, `slot3`, `tariff`, `totalmeters`, `mfactor`, `description`, `connectiondate`, `c1`, `c2`, `c3`, `pf1`, `pf2`, `pf3`, `v1`, `v2`, `v3`, `kwhoffpeak1`, `kwhoffpeak2`, `kwhoffpeak3`, `kwhpeak1`, `kwhpeak2`, `kwhpeak3`, `offpeak`, `peak`, `datetime`, `serialNo`, `assignee_name`, `cnic`, `address`, `mobile`, `email`, `billing_method`, `username`, `password`, `unit_limit`, `status`) VALUES";
        ...
        echo "<script > window.open('db-list.php?filter=0G0','_self'); </script>";
           ...
           echo "<script> alert('There was an error adding Distribution Box:".str_replace("'", "\'", $q)."'); </script>";
         }

      }
      catch(PDOException $e)
      {
        echo "<script> alert('There was an error adding Distribution BOx :".str_replace("'", "\'", $q1)."'); </script>";
      }
