...
<body>
    ...
    <div class="noprint">
        ...
        <?php if($status==0){ ?>
         <button class="btn btn-danger pull-right" style="margin-right: 5px;" onclick="window.location.href = 'bill_pay_collective.php?id=<?php echo $id; ?>'">Pay Bill</button> <?php } ?>
        <br />
        <br />
    </div>
        ...
        <div class="maincontent fontsize">
            <div class="header">
                ...
                <div class="heading">
                    ...
                    <div> 
                        <h3 align="center" style="margin-left: -10%;"> ELECTROCURE COLLECTIVE E-BILL </h3>                                            </div>
                </div>
            </div>
...
<!--                 <img src="images/cuthere.gif" alt="cuthere" id="Img2" />
 ...
 -->                <div style="float: right; margin-right: 206px; height: 70px; margin-bottom: 15px; overflow: hidden;">
                    <!-- <img src="images/barcode.png" id="LinearBarcode1" style="background-color:White;font-family:Times New Roman;font-size:10pt;font-weight:normal;font-style:normal;text-decoration:none;height:89px;width:336px;" /> -->
                     ...
                     echo "<img alt='Bar code' src='barcode.php?codetype=Code39&size=40&text=".$bcode."&print=true'/>"; ?>
