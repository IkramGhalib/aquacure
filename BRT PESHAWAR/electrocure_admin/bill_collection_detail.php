...
<head>
  ...
  <?php $pageName = "ELECTROCURE BILL COLLECTION DETAIL" ?>
...
<br>
 <div id="overflow">
    ...
    if(isset($_POST['btntoday']))
    {
      ...
      $query="SELECT * FROM billing_postpaid WHERE YEAR(paid_on) = YEAR(NOW()) AND MONTH(paid_on) = MONTH(NOW()) AND DAY(paid_on) = DAY(NOW()) AND collected_by='".$collectedBy."'";
...
<?php  } ?>
    ...
    {
   $query="SELECT * FROM billing_postpaid WHERE WEEKOFYEAR(paid_on) = WEEKOFYEAR(NOW()) AND collected_by='".$collectedBy."'";
    $result=$conn->query($query);
    ?>
...
<?php  } ?>
   ...
   <?php
    ...
    {
      $query="SELECT * FROM billing_postpaid WHERE YEAR(paid_on) = YEAR(NOW()) AND MONTH(paid_on)=MONTH(NOW()) AND collected_by='".$collectedBy."'";
      $result=$conn->query($query);
