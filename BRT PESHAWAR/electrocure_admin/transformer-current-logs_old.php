 ...
 <table width="100%" border="0"></table>
    <div  id="overflow" style="overflow-x:auto;">
        ...
        <tbody bgcolor="#FFFFFF">
          ...
          $query= "select tr_current_logs.*,transformer.name from tr_current_logs,transformer WHERE tr_current_logs.trid = transformer.trid and tr_current_logs.trid = '".$filter."' order by tr_current_logs.datetime order by tr_current_logs.datetime desc limit 1000";
          }
