...
<head>
  ...
  <?php $pageName = "ELECTROCURE BILL COLLECTION" ?>
...
<br>
 <div id="overflow">
    ...
    if(isset($_POST['btnsubmit'])){
      ...
      $query="select bill_id,paid_amount,paid_on,collected_by,DATE_FORMAT(paid_on, '%Y-%m-%d') from billing_postpaid
...
?>
    ...
    <!--  <div align="right">Total Collection: </div> -->
    <!-- /.content -->
