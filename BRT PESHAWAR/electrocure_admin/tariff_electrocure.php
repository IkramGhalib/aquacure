...
<head>
  ...
  <?php $pageName = "Electrocure Tariff";?>
 ...
 <!-- DO NOT REMOVE THIS TABLE TAG -->
    ...
    <div  id="overflow" >
        ...
        <tr>     
          ...
          <th scope="col">Fuel Price Adjustment (FPA)</th>
          <th scope="col">GST %</th>
        ...
        <tbody bgcolor="#FFFFFF">
          ...
          $query= "select * from tariff_electrocure order by datetime desc limit 1";
        ...
        ?>
         ...
         <button type="button" class="btn btn-primary" onclick="window.location.href = 'electrocure_change_tariff.php'">Change Tariff</button><br><br>
      </section>
